...
for( var l in labels ) {
  ...
  $('#tab-labels').append('<a class="tab-label" href="set_mode('+labels[l]+')">'+labels[l]+'</a>');
...
for( var j in joints ) {
  ...
  $('#nao-joints-show').append('<input type="range" class="show-slide" name="'+j+'-show" id="'+j+'-show" value="50" min="0" max="100">');
  $('#nao-joints-show').append('<br/>');
  $('#nao-joints-edit').append('<label class="edit-slide-label" for="'+j+'-show">'+joint+'</label>');
  $('#nao-joints-edit').append('<br/>');
  $('#nao-joints-edit').append('<input type="range" class="edit-slide" name="'+j+'-edit" id="'+j+'-edit" value="50" min="0" max="100">');
  $('#nao-joints-edit').append('<br/>');
}
